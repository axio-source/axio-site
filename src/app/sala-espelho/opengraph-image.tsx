...
export const alt = 'Sala Espelho, Axio'
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Headline principal */}
        <div style={{ color: '#FFFFFF', fontSize: '58px', fontWeight: 700, lineHeight: 1.1, marginBottom: '28px', maxWidth: '980px', textTransform: 'uppercase', display: 'flex', flexWrap: 'wrap' }}>
          Pare de gastar para descobrir. Descubra antes de gastar.
        </div>
        ...
        {/* Subtítulo */}
        <div style={{ color: '#7D7D7D', fontSize: '26px', letterSpacing: '1px', display: 'flex' }}>
          Da Visita à Sala Mestra, preço exato: R$1.197 a R$70.793.
        </div>

        {/* URL */}
        <div style={{ position: 'absolute', bottom: '36px', right: '80px', color: '#FFC000', fontSize: '18px', letterSpacing: '2px', display: 'flex' }}>
          axio.gold/sala-espelho
        </div>
      </div>
    ),
    { ...size }
