    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-6">
          <a
            href="mailto:rodrigo@axio.gold"
            aria-label="E-mail da Axio"
          ...
          <a
            href="https://wa.me/5512981764882?text=Ol%C3%A1%2C%20vim%20pelo%20site%20da%20Axio."
            target="_blank"
            rel="noopener noreferrer"
            aria-label="WhatsApp da Axio"
            className="text-ash/60 hover:text-gold transition-colors duration-200"
          >
